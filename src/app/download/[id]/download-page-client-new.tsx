...
import { Clock, FileText, AlertTriangle, Lock, User, Folder, Upload, Shield } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <main className="flex-1 flex">
          {/* Left Column - Error Content (40% width on large screens) */}
              ...
              >
                <Card className="border-0 shadow-none overflow-hidden rounded-3xl bg-card/95 backdrop-blur-sm">
                  <CardHeader className="text-center pb-8 pt-12">
                    <div className="mx-auto mb-6 h-20 w-20 rounded-2xl bg-destructive/10 flex items-center justify-center">
                  ...
                  <CardContent className="pb-12">
                    <Alert variant="destructive" className="mb-6">
                      ...
                      <AlertDescription>
                        {isExpired 
                          ? t.fileNoLongerAvailable
                          : t.maxDownloadsReached
                        }
                      </AlertDescription>
                    </Alert>
            ...
            >
              <Card className="border-0 shadow-none overflow-hidden rounded-3xl bg-card/95 backdrop-blur-sm">
                <CardHeader className="text-center pb-8 pt-12">
                  ...
                  <CardDescription className="text-base">
                    {fileRecord.is_folder ? t.folderShared : t.fileSharedWithYou}
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-6 pb-12">
                  ...
                  <div className="space-y-4 bg-muted/30 p-6 rounded-xl">
                    ...
                    <div className="space-y-3">
                      ...
                      {fileRecord.is_folder && fileRecord.total_files && (
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-muted-foreground">{t.files}</span>
                          <span className="font-medium">{fileRecord.total_files}</span>
                        </div>
                      )}
                      <div className="flex justify-between items-center text-sm">
                        <span className="text-muted-foreground">{t.uploaded}</span>
                      ...
                      {fileRecord.max_downloads && (
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-muted-foreground">{t.downloadsRemaining}</span>
                          <span className="font-medium">{fileRecord.max_downloads - fileRecord.download_count} / {fileRecord.max_downloads}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <DownloadSection 
                    ...
                    requiresPassword={fileRecord.access_control === 'password'}
                  ...
                  <div className="mt-8 text-center pt-4 border-t border-border/50">
                    ...
                    <Link href="/">
                      <button className="w-full py-3 px-4 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-lg transition-colors inline-flex items-center justify-center gap-2">
